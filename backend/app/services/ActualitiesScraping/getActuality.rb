...
class ActualitiesScraping::GetActuality < ApplicationService
    def initialize(actualities)
        ...
        actualities[:csGoActu] ? @elements.push({url: "https://www.team-aaa.com/rss/game_csgo.xml", img: "https://s2.best-wallpaper.net/wallpaper/1920x1080/1803/Counter-Strike-Global-Offensive-CS-game_1920x1080.jpg"}) : ""
