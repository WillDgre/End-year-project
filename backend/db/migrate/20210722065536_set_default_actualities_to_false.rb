class SetDefaultActualitiesToFalse < ActiveRecord::Migration[6.1]
  def change
    change_column :actualities, :lolActu, :boolean, default: false
    ...
    change_column :actualities, :overwatchActu, :boolean, default: false
    change_column :actualities, :pubgActu, :boolean, default: false
