...
ActiveRecord::Schema.define(version: 2021_07_22_065536) do

  create_table "actualities", force: :cascade do |t|
    t.boolean "lolActu", default: false
    ...
    t.boolean "overwatchActu", default: false
    t.boolean "pubgActu", default: false
  ...
  create_table "instant_gaming_games", force: :cascade do |t|
    t.string "name"
    t.decimal "price"
    t.string "link"
    t.string "imglink"
